...
def train(env_name="gym", map_name="CartPole-v1", alg_name="dueling_dqn"):
...
def evaluate(env_name="gym", map_name="CartPole-v1", alg_name="dueling_dqn"):
    env = e_REGISTRY[env_name](map_name)
    agent = a_REGISTRY[alg_name](env)
